...
const Home = () => {
   ...
   const cardBaseClasses =
      'bg-gradient-to-br from-zinc-950 to-stone-900 border border-gray-700 p-4 rounded-sm hover:shadow-lg transition-all duration-300 transform hover:scale-[1.01] group relative overflow-hidden';
   const cardFlexContainerClasses = 'flex items-start mb-3';
   const cardIconContainerClasses = 'mr-3 text-amber-400 transition-transform duration-300';
   const cardIconClasses = 'w-8 h-8';
   const cardTitleClasses =
      'text-base font-medium text-gray-200 mb-1 group-hover:text-amber-300 transition-colors duration-200';
   const cardDescriptionClasses = 'text-sm text-gray-400 mb-3';
   const cardButtonClasses =
      'inline-block px-4 py-1.5 bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-white text-sm rounded-sm hover:shadow-md hover:shadow-amber-900/50 transition-all duration-300';
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
         ...
         <div className="relative mb-6">
            ...
            <div className="flex items-center mb-2">
               <div className="h-10 w-10 text-amber-500 mr-4 relative">
                  <svg
                     viewBox="0 0 24 24"
                     fill="none"
               ...
               <h1 className="text-3xl font-medium text-gray-100 relative">
                  Hub
                  <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-amber-500 to-transparent mt-1 opacity-60"></div>
               </h1>
            </div>
            <div
            ...
            >
               Welcome to Castora: junk-free source curation and podcast generation.
            </div>
         </div>
         <div className="bg-gradient-to-br from-stone-900 to-zinc-950 shadow-lg rounded-sm relative overflow-hidden">
