...
const ArticleDetail = () => {
      ...
      return (
         <div className="flex flex-wrap gap-2 mt-3">
            {categories.map((category, index) => (
               <span
                  key={index}
                  className="px-2 py-1 bg-gray-800 text-amber-300 rounded-sm text-xs font-medium border border-gray-700"
               >
                  {category}
               </span>
            ))}
   ...
   return (
      <div className="max-w-3xl mx-auto py-8">
         <button
            onClick={handleGoBack}
            className="text-gray-300 hover:text-amber-300 flex items-center mb-8 transition-colors duration-200 group"
         >
            <svg
               xmlns="http://www.w3.org/2000/svg"
         ...
         <article className="bg-gray-800 shadow-lg rounded-sm overflow-hidden">
            <div className="p-6 border-b border-gray-700">
               {article.source_name && (
                  <div className="mb-3">
                     <span className="px-3 py-1 bg-gray-900 text-amber-300 rounded-sm text-sm font-medium">
                        {article.source_name}
                     </span>
                  </div>
               )}
            ...
            {article.summary && (
               <div className="px-6 py-5 bg-gray-750 border-b border-gray-700">
                  <h2 className="text-lg font-medium text-amber-300 mb-3">Summary</h2>
                  <p className="text-gray-300 leading-relaxed">{article.summary}</p>
               </div>
            )}
            {article.content && (
               <div className="p-6">
                  <h2 className="text-lg font-medium text-amber-300 mb-4">Content</h2>
            ...
            {article.url && (
               <div className="px-6 py-5 bg-gray-750 border-t border-gray-700">
                  <a
                     ...
                     className="inline-flex items-center px-5 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-sm transition-colors duration-200"
                  >
                     <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 mr-2"
