...
const Voyager = () => {
   ...
   return (
      <div className="max-w-6xl mx-auto">
         ...
         {error && (
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 shadow-lg rounded-sm overflow-hidden border border-red-700 p-4 mb-6">
               <div className="flex">
                  ...
                  <div className="flex justify-between items-center mb-4">
                     ...
                     <div className="flex space-x-2">
                        ...
                        <button
                           ...
                           className="px-3 py-1.5 text-sm rounded-sm bg-gradient-to-r from-amber-700 to-amber-800 text-white border border-amber-600 hover:from-amber-600 hover:to-amber-700 transition-colors duration-200"
                        >
                           New Task
                        </button>
                     </div>
                           ...
                           <tbody className="divide-y divide-gray-700">
                              {tasks.map(task => (
                                 ...
                                 >
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap">
                                       <span className="px-2 py-0.5 text-xs rounded-sm bg-gradient-to-r from-zinc-950 to-stone-900 text-amber-300 border border-gray-700">
                                       ...
                                       <div className="flex items-center">
                                          ...
                                          <span
                                             className={`ml-2 text-sm ${
                                                task.enabled ? 'text-amber-400' : 'text-gray-500'
                                             }`}
                                          >
                                 ...
                                 >
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap">
                                       <div className="flex flex-col space-y-1">
                                          ...
                                          <span className="px-2 py-0.5 text-xs rounded-sm bg-gradient-to-r from-zinc-950 to-stone-900 text-blue-300 border border-gray-700">
                                             Limit: {config.limit_articles} articles
                                          </span>
                                          <span className="px-2 py-0.5 text-xs rounded-sm bg-gradient-to-r from-zinc-950 to-stone-900 text-purple-300 border border-gray-700">
                     ...
                     <div className="flex flex-wrap items-center space-x-2">
                        <div className="relative">
                           <select
                              ...
                              className="bg-gradient-to-r from-stone-900 to-zinc-950 border border-gray-700 text-gray-300 text-sm rounded-sm px-3 py-1.5 focus:outline-none focus:ring-1 focus:ring-amber-500"
                           >
                        ...
                        {taskExecutions.length > 0 && (
                           <div className="mt-4 flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                 ...
                                 <span className="px-3 py-1 text-sm bg-gradient-to-b from-gray-700 to-gray-800 text-amber-400 rounded-sm">
         ...
         {isModalOpen && (
            ...
            >
               ...
               <div className="flex items-center justify-center min-h-screen p-4">
                  <div
                     className="bg-gradient-to-br from-stone-900 to-zinc-950 rounded-sm max-w-lg w-full p-6 shadow-2xl border border-gray-700 relative transform transition-all"
         ...
         {isConfigModalOpen && (
            ...
            >
               ...
               <div className="flex items-center justify-center min-h-screen p-4">
                  <div
                     className="bg-gradient-to-br from-stone-900 to-zinc-950 rounded-sm max-w-2xl w-full p-6 shadow-2xl border border-gray-700 relative transform transition-all"
                     onClick={e => e.stopPropagation()}
                  >
                     <button
                        onClick={handleCloseConfigModal}
         ...
         {viewOutputModal && (
            ...
            >
               ...
               <div className="flex items-center justify-center min-h-screen p-4">
                  <div
                     className="bg-gradient-to-br from-stone-900 to-zinc-950 rounded-sm max-w-3xl w-full p-6 shadow-2xl border border-gray-700 relative transform transition-all"
                     onClick={e => e.stopPropagation()}
                  >
                     <button
                        onClick={handleCloseOutputModal}
