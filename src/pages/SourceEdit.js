...
const SourceEdit = () => {
   ...
   return (
      <div className="max-w-4xl mx-auto">
         ...
         {error && (
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border-l-4 border-red-500 p-4 rounded-sm shadow-sm mb-6 text-red-400">
               {error}
            </div>
         )}
               ...
               <div className="grid grid-cols-1 gap-6">
                     ...
                     <div className="flex flex-wrap gap-2 mb-2">
                        {source.categories &&
                           source.categories.map((category, index) => (
                              <div
                                 key={index}
                                 className="flex items-center px-2 py-1 bg-gradient-to-r from-zinc-950 to-stone-900 text-gray-300 rounded-sm border border-gray-700"
                              >
                     ...
                     <div className="space-y-2">
                        <div className="flex">
                           <select
                              ...
                              className="flex-1 px-3 py-2 bg-gradient-to-r from-zinc-950 to-stone-900 border border-gray-700 rounded-l-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-400 sm:text-sm text-gray-300"
                           >
                           ...
                           <button
                              ...
                              className="px-3 py-2 bg-gradient-to-r from-amber-700 to-amber-800 text-white rounded-r-sm border border-amber-600 hover:from-amber-600 hover:to-amber-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                           >
                              Add
                           </button>
                        </div>
                        {showCustomInput && (
                           <div className="flex mt-2">
                              <input
                                 ...
                                 className="flex-1 px-3 py-2 bg-gradient-to-r from-zinc-950 to-stone-900 border border-gray-700 rounded-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-400 sm:text-sm text-gray-300"
                              />
                           </div>
                        )}
                     </div>
                  ...
                  <div className="flex justify-end space-x-3 mt-4">
                     ...
                     <button
                        type="submit"
                        disabled={loading}
                        className="px-4 py-2 bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-white rounded-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-900 text-sm transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                     >
                        {loading && (
                           <svg
