...
const StudioLanding = () => {
   ...
   return (
      <div className="min-h-screen flex bg-gray-900">
         ...
         <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-gradient-to-r from-zinc-950 to-stone-900 z-10 border-b border-gray-700 flex items-center px-4">
            <button
         ...
         <div
            ...
            style={{ marginLeft: 0 }}
         >
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border border-gray-700 rounded-md shadow-2xl max-w-md w-full p-6 backdrop-blur">
               <div className="relative w-20 h-20 mx-auto mb-6">
                  <div className="absolute inset-0 bg-amber-500 opacity-5 rounded-full animate-pulse-slow"></div>
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                     <svg
                        viewBox="0 0 24 24"
               ...
               <button
                  ...
                  disabled={loading}
                  className={`w-full py-3 bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-white font-medium rounded-md transition flex items-center justify-center shadow-lg hover:shadow-amber-900/20 ${
               ...
               <div className="mt-8 space-y-2">
                  ...
                  <div className="flex items-start">
                     <div className="h-5 w-5 rounded-full bg-amber-900/50 border border-amber-800/50 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg
