   ...
   return (
      <button
         ...
         className={`relative inline-flex h-5 w-10 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 ${
            ...
            isActive ? 'bg-amber-600 focus:ring-amber-500' : 'bg-gray-700 focus:ring-gray-500'
         }`}
      >
         <span
   ...
   return (
      <div className="max-w-6xl mx-auto">
         ...
         {loading ? (
            ...
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 shadow-lg rounded-sm p-6 text-center border border-gray-700">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
               ...
               <div className="text-sm text-gray-500 bg-gradient-to-r from-zinc-950 to-stone-900 p-3 rounded-sm mx-auto max-w-md border border-gray-700">
            ...
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 shadow-lg rounded-sm p-8 text-center border border-gray-700">
               <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
               {podcasts.map(podcast => (
                  <Link
                     ...
                     className="block bg-gradient-to-br from-stone-900 to-zinc-950 shadow-lg rounded-sm overflow-hidden border border-gray-700 hover:border-gray-600 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl"
                  ...
                  >
                     <div className="relative">
                        {podcast.banner_img ? (
                           <div className="h-32 w-full overflow-hidden relative">
                              ...
                              {podcast.audio_generated && (
                                 <div className="absolute top-2 right-2 flex items-center bg-gray-900 bg-opacity-75 px-2 py-1 rounded-full text-amber-400 text-xs">
                                    <svg
                                       xmlns="http://www.w3.org/2000/svg"
                           ...
                           <div className="h-32 flex items-center justify-center bg-gradient-to-r from-zinc-950 to-stone-900 border-b border-gray-700 relative">
                        ...
                        <div
                           className={`absolute bottom-3 right-3 w-6 h-6 flex items-center justify-center rounded-full bg-gray-900 bg-opacity-70 text-amber-400 transition-opacity duration-200 ${
