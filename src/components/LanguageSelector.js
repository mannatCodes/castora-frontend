      ...
      <>
            ...
            <button
               ...
               className={`w-full flex items-center justify-between px-2 py-1.5 bg-gradient-to-r from-gray-800/50 to-gray-700/50 border border-gray-700/50 rounded-lg transition-all duration-200 ${
                  isDisabled
                     ...
                     : 'hover:border-gray-600/50 hover:bg-gradient-to-r hover:from-gray-700/50 hover:to-gray-600/50 focus:outline-none focus:ring-2 focus:ring-amber-500/50'
               }`}
            >
         ...
         {isOpen && (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
               <div className="bg-gradient-to-br from-zinc-950 to-stone-900 rounded-lg border border-gray-700/50 w-full max-w-sm max-h-[60vh] flex flex-col shadow-xl">
                     ...
                     <div className="p-2 border-b border-gray-700/30">
                        <div className="relative">
                           ...
                           <input
                              ...
                              className="w-full pl-7 pr-2 py-1.5 bg-gray-800/50 border border-gray-700/50 rounded-md text-xs text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-transparent"
                           />
                        </div>
                     </div>
                  )}
                              ...
                              <button
                                 ...
                                 className={`w-full flex items-center gap-2 px-2 py-1.5 text-left transition-all duration-200 rounded-md ${
                                    selectedLanguage === language.code
                                       ? 'bg-gradient-to-r from-amber-500/20 to-sky-500/20 border border-amber-500/30 text-white'
