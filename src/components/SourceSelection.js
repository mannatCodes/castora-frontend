...
const SourceIcon = ({ url }) => {
   ...
   const defaultIconSvg = (
      <ExternalLink className="w-2.5 h-2.5 text-amber-400 transition-transform duration-200 group-hover:scale-110" />
   );
...
const SourceSelection = ({
   ...
   return (
      <div className="w-full max-w-2xl mx-auto mt-2">
         <div className="bg-gradient-to-br from-gray-900 via-stone-900 to-gray-800 rounded-md overflow-hidden shadow-lg border border-gray-700/50 transition-all duration-300 hover:shadow-xl">
               ...
               <div className="relative">
                  <div className="flex items-center justify-between">
                     <div className="flex items-center gap-1.5">
                        <div className="p-0.5 bg-gradient-to-br from-amber-500/20 to-sky-500/20 rounded-sm">
                     ...
                     <div className="flex items-center">
                        <div className="text-xs text-amber-400 bg-amber-500/20 px-1.5 py-0.5 rounded-sm border border-amber-500/30">
                     ...
                     <div
                        ...
                        className={`group relative p-2 rounded-md border transition-all duration-300 cursor-pointer ${
                           selectedIndices.includes(index)
                              ? 'bg-gradient-to-r from-amber-500/10 to-sky-500/10 border-amber-500/30 shadow-md'
            ...
            <div className="px-2 py-1.5 bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur border-t border-gray-700/30">
               <div className="flex items-center justify-between">
                  ...
                  <button
                     ...
                     className={`group flex items-center justify-center gap-1 px-3 py-1 bg-gradient-to-r from-amber-600 to-sky-600 hover:from-amber-500 hover:to-sky-500 text-white text-xs font-medium rounded-md transition-all duration-200 hover:scale-105 hover:shadow-md border border-amber-500/30 ${
