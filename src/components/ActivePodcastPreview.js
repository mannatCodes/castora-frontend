...
const SourceIcon = ({ url }) => {
   ...
   const defaultIconSvg = (
      <ExternalLink className="w-3 h-3 text-amber-400 transition-transform duration-200 group-hover:scale-110" />
   );
...
const ActivePodcastPreview = React.memo(
   ({
      ...
      const SectionHeader = ({ title, icon, id, subtitle }) => (
         ...
         >
            <div className="flex items-center gap-2 mb-2">
               <div className="p-1.5 bg-gradient-to-br from-amber-500/20 to-sky-500/20 rounded-lg">
                  {React.cloneElement(icon, { className: 'w-4 h-4 text-amber-400' })}
               </div>
               <div>
         ...
         <button
            ...
            className={`flex flex-col items-center px-2 py-1 rounded-md transition-all duration-200 ${
               isActive
                  ...
                  : 'text-gray-400 hover:text-amber-300 hover:bg-gray-700/30'
            }`}
         >
            {React.cloneElement(icon, {
               className: `w-3 h-3 ${isActive ? 'text-amber-400' : 'text-gray-400'}`,
            })}
      ...
      return (
         <div className="h-full flex flex-col relative bg-gradient-to-br from-gray-900 via-stone-900 to-gray-800">
            {!showRecordingPlayer && (
               <>
                  <div className="px-4 py-3 border-b border-gray-700/30">
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                           <div className="inline-flex items-center px-2 py-1 rounded-lg bg-gradient-to-r from-amber-500/20 to-sky-500/20 border border-amber-500/30">
                              <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mr-1.5 animate-pulse"></div>
                              <span className="text-xs font-medium text-amber-300">Active</span>
                           </div>
                        </div>
                        {onClose && (
                           <button
                                             ...
                                             <div className="flex-1 min-w-0">
                                                ...
                                                {source.url && (
                                                   <a
                                                      ...
                                                      className="text-xs text-amber-400 hover:text-amber-300 truncate block mt-1"
                                                   >
                                    ...
                                    {scriptData.sections.map((section, sectionIndex) => (
                                       <div key={sectionIndex}>
                                          <div className="mb-2">
                                             ...
                                             <div className="h-px bg-gradient-to-r from-amber-500/30 to-transparent mt-1" />
                                          </div>
                  ...
                  {audioUrl && (
                     <div className="border-t border-gray-700/30 p-3 bg-gradient-to-r from-gray-900/90 to-gray-800/90 backdrop-blur-sm">
                        <div className="flex items-center justify-between">
                           ...
                           <button
                              onClick={() => scrollToSection('audio')}
                              className="px-2 py-1 text-xs text-amber-400 hover:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 rounded-lg transition-all duration-200 border border-amber-500/30"
                           >
                              Play
                           </button>
                        </div>
                  ...
                  <div className="w-full h-full flex flex-col">
                     ...
                     <div className="p-6 border-t border-gray-700/30 flex-shrink-0">
                        ...
                        <div className="flex justify-end">
                           <button
                              onClick={() => setShowRecordingPlayer(false)}
                              className="px-4 py-2 bg-gradient-to-r from-amber-600 to-sky-600 hover:from-amber-500 hover:to-sky-500 text-white font-medium rounded-lg transition-all duration-200"
                           >
                              Close
                           </button>
                        </div>
