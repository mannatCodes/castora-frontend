      ...
      <div className="space-y-4 overflow-hidden">
         <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
            <div className="flex items-center">
               <div className="flex-shrink-0 w-7 h-7 rounded-full bg-amber-900/30 flex items-center justify-center mr-2.5">
                  <svg
         ...
         <div className="py-2 overflow-auto scrollbar-hide-when-inactive animate-fadeIn">
            <div className="flex flex-col md:flex-row gap-6">
               <div className="md:w-1/3 flex flex-col space-y-4">
                  <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border border-gray-700 rounded-md shadow-md overflow-hidden flex flex-col">
                     {bannerUrl ? (
                  ...
                  {recordingUrl && (
                     <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border border-gray-700 rounded-md shadow-md overflow-hidden">
                        <div className="p-2.5 border-b border-gray-700 bg-gradient-to-r from-zinc-950 to-stone-900">
               ...
               <div className="md:w-2/3 flex flex-col space-y-4">
                  {podcastId && (
                     <div className="bg-gradient-to-r from-amber-900/40 to-amber-900/10 border border-amber-700/30 rounded-md p-3 flex items-start">
                        <div className="flex-shrink-0 w-4 h-4 text-amber-400 mt-0.5">
                        ...
                        <div className="ml-2.5 flex-1">
                           <p className="text-xs text-amber-300">
                              ...
                              <Link
                                 to="/podcasts"
                                 className="font-medium text-amber-400 hover:text-amber-300 underline ml-1"
                              >
                                 Podcasts page
                              </Link>
                           </p>
                           <div className="mt-1.5">
                              <Link
                                 ...
                                 className="inline-flex items-center px-2.5 py-1 bg-amber-800/40 hover:bg-amber-800 text-amber-200 text-xs rounded-sm border border-amber-700/50 transition-colors"
                              >
                                 <svg
                  ...
                  <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border border-gray-700 rounded-md shadow-md">
                     <div className="p-2.5 border-b border-gray-700 bg-gradient-to-r from-zinc-950 to-stone-900">
                     ...
                     <div className="p-3 grid grid-cols-2 gap-2">
                        ...
                        <button
                           onClick={onNewPodcast}
                           className="bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-white rounded-sm py-1.5 px-3 text-xs flex items-center justify-center"
                        >
                           <svg
                              className="w-3.5 h-3.5 mr-1"
                              viewBox="0 0 20 20"
                     ...
                     <div className="p-3">
                        ...
                        <div className="space-y-2">
                           <div className="flex items-start">
                              <div className="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-amber-900/30 text-amber-500 mr-2">
                                 <svg
         ...
         {isScriptModalOpen && (
            <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
               <div className="bg-gradient-to-br from-stone-900 to-zinc-950 border border-gray-700 rounded-md max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl animate-fadeIn">
                  <div className="p-3 border-b border-gray-700 bg-gradient-to-r from-zinc-950 to-stone-900 flex items-center justify-between">
                  ...
                  <div className="p-3 border-t border-gray-700 bg-gradient-to-r from-zinc-950 to-stone-900 flex justify-end">
                     <button
                        onClick={onToggleScriptModal}
