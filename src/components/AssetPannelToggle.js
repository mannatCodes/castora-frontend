...
const PodcastAssetsToggle = ({ isVisible, onClick }) => {
   return (
      ...
      >
         ...
         >
            <div className="absolute inset-0 bg-amber-800/20 blur-sm"></div>
            <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-amber-600/0 via-amber-500/80 to-amber-600/0"></div>
         </div>
