...
const Sidebar = ({ onNewSession, onSessionSelect }) => {
   ...
   const getStatusBadge = stage => {
      const statusConfig = {
         ...
         script: {
            class: 'bg-sky-900/30 text-sky-300 border-sky-600/30',
            label: 'script',
         },
         banner: {
         ...
         complete: {
            class: 'bg-amber-900/30 text-amber-300 border-amber-600/30',
            label: 'complete',
         },
      };
   ...
   return (
      <div className="h-full flex flex-col bg-gradient-to-br from-gray-900 via-stone-900 to-gray-800">
            ...
            >
               <div className="space-y-0.5 py-0.5">
                  {navLinks.map(link => (
                     ...
                     >
                        <span className="text-gray-500 group-hover:text-amber-400 transition-colors mr-2">
                           {link.icon}
                        </span>
                        {link.name}
                     </Link>
         ...
         <div className="flex-1 overflow-y-auto px-3 pt-2 pb-2">
            <div className="text-xs text-gray-300 mb-2 flex items-center justify-between">
               ...
               <button
                  ...
                  className="p-1.5 text-gray-500 hover:text-amber-400 hover:bg-gray-800/40 rounded-md transition-all duration-200"
                        ...
                        return (
                           <div
                              ...
                              className={`group relative p-2 rounded-lg cursor-pointer transition-all duration-200 ${
                                 isActive
                                    ? 'bg-gradient-to-r from-amber-500/10 to-sky-500/10 border border-amber-500/30 shadow-md shadow-amber-500/5'
         ...
         <div className="p-3 border-t border-gray-700/30">
            <button
               ...
               disabled={isCreating}
               className={`w-full flex items-center justify-center py-2 bg-gradient-to-r from-amber-600 to-sky-600 hover:from-amber-500 hover:to-sky-500 text-white rounded-lg transition-all duration-200 text-xs font-medium shadow-md hover:shadow-amber-500/25 ${
         ...
         {showDeleteModal && (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
               <div className="bg-gradient-to-br from-zinc-950 to-stone-900 border border-gray-700/50 rounded-xl max-w-md w-full p-4 shadow-2xl animate-fade-in-up">
