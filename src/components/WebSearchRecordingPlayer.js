   ...
   if (isLoading) {
      return (
         <div className="mb-4 fade-in">
            <div className="bg-gradient-to-br from-stone-900 to-zinc-950 backdrop-blur-sm border border-gray-700 rounded-sm overflow-hidden shadow-lg">
      ...
      <div className="mb-4 fade-in">
         <div className="bg-gradient-to-br from-stone-900 to-zinc-950 backdrop-blur-sm border border-gray-700 rounded-sm overflow-hidden shadow-lg">
            <div className="px-4 py-3 border-b border-gray-700 flex items-center justify-between">
               ...
               <div className="flex items-center space-x-2">
                  <div className="text-xs px-2 py-0.5 rounded-sm bg-amber-900/50 text-amber-300 border border-amber-800/50">
                     AI Search Process
                  </div>
                  <button
                     onClick={onClose}
            ...
            <div className="px-4 py-3 bg-gradient-to-r from-stone-900 to-zinc-950 flex justify-between items-center">
               ...
               <button
                  onClick={onClose}
                  disabled={isProcessing}
                  className={`px-3 py-1.5 text-xs bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-600 hover:to-amber-700 text-white font-medium rounded-sm transition flex items-center ${
                     isProcessing ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
               >
