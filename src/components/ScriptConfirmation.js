...
const SourceIcon = ({ url }) => {
   ...
   const defaultIconSvg = (
      <svg
         className="w-2.5 h-2.5 text-amber-400 transition-transform duration-200 group-hover:scale-110"
         fill="none"
         viewBox="0 0 24 24"
         stroke="currentColor"
      >
   ...
   return (
      <>
         <div className="w-full max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-gray-900 via-stone-900 to-gray-800 rounded-lg overflow-hidden shadow-xl border border-gray-700/50 transition-all duration-300 hover:shadow-2xl">
                  ...
                  <div className="relative">
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                           <div className="p-1 bg-gradient-to-br from-amber-500/20 to-sky-500/20 rounded-md">
                     ...
                     {hasStructuredScript ? (
                        <div className="space-y-2">
                           ...
                           <div className="pt-2 border-t border-gray-600/30">
                              <div
                                 className="text-amber-400 text-xs font-medium cursor-pointer hover:underline flex items-center gap-1"
                        ...
                        <div>
                           ...
                           <div className="pt-2 border-t border-gray-600/30">
                              <div
                                 className="text-amber-400 text-xs cursor-pointer hover:underline flex items-center gap-1"
                                 onClick={() => !isProcessing && onToggleModal()}
                              >
                                 <Sparkles className="w-3 h-3" />
               ...
               <div className="px-3 py-2 bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur border-t border-gray-700/30">
                  <div className="flex justify-center">
                     <button
                        onClick={onApprove}
                        disabled={isProcessing}
                        className={`group flex items-center justify-center gap-1.5 px-4 py-1.5 bg-gradient-to-r from-amber-600 to-sky-600 hover:from-amber-500 hover:to-sky-500 text-white text-sm font-medium rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-amber-500/25 border border-amber-500/30 ${
         ...
         {isModalOpen && (
            <div className="fixed inset-0 bg-black/95 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4">
               <div className="bg-gradient-to-br from-zinc-950 to-stone-900 rounded-lg border border-gray-700/50 w-full max-w-full sm:max-w-5xl h-full sm:h-[80vh] flex flex-col shadow-xl">
                                          ...
                                          {scriptData.sources.map((source, index) => (
                                             ...
                                             >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                   <div className="text-amber-400 group-hover:text-amber-300 text-xs font-medium truncate">
                  ...
                  <div className="px-3 sm:px-4 py-3 border-t border-gray-700/30 flex justify-end flex-shrink-0">
                     <button
                        ...
                        disabled={isProcessing}
                        className={`flex items-center gap-1.5 px-3 sm:px-4 py-2 bg-gradient-to-r from-amber-600 to-sky-600 hover:from-amber-500 hover:to-sky-500 text-white text-xs sm:text-sm font-medium rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-amber-500/25 border border-amber-500/30 ${
                           isProcessing ? 'opacity-70 cursor-not-allowed' : ''
                        }`}
                     >
                        {isProcessing ? (
