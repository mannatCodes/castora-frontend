         ...
         <div className="bg-gradient-to-br from-gray-900 via-stone-900 to-gray-800 rounded-lg overflow-hidden shadow-xl border border-gray-700/50 transition-all duration-300 hover:shadow-2xl">
            <div className="relative px-3 py-2 bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur border-b border-gray-700/30">
               ...
               <div className="relative flex items-center gap-2">
                  <div
                     className={`p-1 bg-gradient-to-br from-amber-500/20 to-sky-500/20 rounded-md transition-all duration-300 ${
               ...
               <div className="relative">
                  ...
                  {isPlaying && (
                     <div className="absolute inset-0 rounded-lg">
                        <div className="absolute inset-0 border-2 border-amber-500/20 rounded-lg animate-ping" />
                        <div className="absolute inset-2 border border-amber-400/10 rounded-lg animate-pulse" />
                     </div>
                  )}
                  ...
                  <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-amber-500/5 to-sky-500/5 pointer-events-none" />
               </div>
               <div className="mt-2 flex items-center justify-center gap-1 h-8 overflow-hidden">
                  {Array.from({ length: 32 }, (_, i) => (
                     <div
                        key={i}
                        className={`bg-gradient-to-t from-amber-500/40 to-sky-400/40 rounded-full transition-all duration-200 ${
            ...
            {isPlaying && (
               <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden rounded-lg">
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72">
                     ...
                     />
                     <div
                        className="absolute inset-6 border border-sky-400/10 rounded-full animate-ping"
                        style={{ animationDuration: '2s', animationDelay: '0.5s' }}
                     />
                     <div
                        className="absolute inset-12 border border-amber-300/10 rounded-full animate-ping"
